...
func (r *ticketsRepository) GetTicketsByEvent(ctx context.Context, eventID string) ([]*entities.Ticket, error) {
...
func (r *ticketsRepository) GetTicketsByUser(ctx context.Context, userID string) ([]*entities.Ticket, error) {
    var tickets []models.Ticket
    err := r.db.WithContext(ctx).
